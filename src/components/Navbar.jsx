...
<nav className="bg-black border-gray-200 dark:bg-gray-900 text-white w-screen">
  <div className=" flex flex-wrap items-end justify-between  p-4">
    <div className="flex items-end gap-1">
        <img src={logo} className="h-65" alt="Logo" />
        <span style={{fontFamily:'Just Another Hand'}} className="self-center text-[4rem] font-normal  whitespace-nowrap leading-[4rem] ">Movies</span>
    </div>
    
    <div className="hidden w-full sm:block md:block md:w-auto lg:w-[50vw] lg:flex lg:justify-around" id="navbar-default">
      <ul className="font-medium flex  flex-col h-12 p-3 text-[white] mx-3 md:p-0 mt-4 border md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0  md:dark:bg-gray-900">
